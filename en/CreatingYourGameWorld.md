1. Cameras are important in Unity. The camera displays what the player of your game sees. Lights in Unity do exactly what they do in real life. You can move lights around to see objects better. Make sure the **Transform** of the "Main Camera" is set to position (0, 0, -15) and position of the **Transform** of the "Directional Light" is set to (0, 0, -15).

2. Create a 3D Object **Quad** and rename it to "Background" and set the **Transform** position to (0, 0, 1). Make sure the **Rotation** is (0, 0, 0).
